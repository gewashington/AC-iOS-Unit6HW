...
// UIColor(red: 51/255, green: 156/255, blue: 255/255, alpha: 1.0) /* #339cff */
//UIColor(red: 92/255, green: 163/255, blue: 230/255, alpha: 1.0) #5ca3e6
import UIKit
import Firebase
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        //        let viewController = LogInOrCreateAccountViewController() //the story board you created
        //        let viewController = CategoriesViewController()
        //        let navCon = UINavigationController(rootViewController: viewController)
        //        window?.rootViewController = navCon //makes a rootController
